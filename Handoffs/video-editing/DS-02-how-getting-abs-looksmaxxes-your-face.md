...
## Deliver
`Short-form video content/ds-02_how-getting-abs-looksmaxxes-your-face.mp4` + stamps + covers. **Don't upload or queue.** Organic shorts go out through Blotato, uploaded Private (`/video-setup` step, separate). Send Dan the review copy. Update `00-MASTER.md`.
