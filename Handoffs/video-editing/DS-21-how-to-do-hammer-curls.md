...
## Deliver
`Short-form video content/ds-21_how-to-do-hammer-curls.mp4` + stamps + covers. **Don't upload or queue.** Organic shorts go out through Blotato, uploaded Private (`/video-setup` step, separate). Send Dan the review copy. Update `00-MASTER.md`.
