...
## Deliver
`Short-form video content/ds-13_number-1-change-to-get-abs-at-40.mp4` + stamps + covers. **Don't upload or queue.** Organic shorts go out through Blotato, uploaded Private (`/video-setup` step, separate). Send Dan the review copy. Update `00-MASTER.md`.
