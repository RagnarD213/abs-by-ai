...
## Deliver
`Short-form video content/ds-07_top-3-ways-to-use-ai-to-get-abs.mp4` + stamps + covers. **Don't upload or queue.** Organic shorts go out through Blotato, uploaded Private (`/video-setup` step, separate). Send Dan the review copy. Update `00-MASTER.md`.
