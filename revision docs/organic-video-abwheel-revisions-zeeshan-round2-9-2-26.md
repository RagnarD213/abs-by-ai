...
**THE LIVE WORKOUT SETS ARE STILL MISSING**

- This was the number one item in round 1 and it is not in this cut. The video goes straight from "leave about one rep in the tank" (4:48) into the call to action. About 100 seconds of the script is still not in the video: "Let's talk about what it looks like live" / "Alright, let's do it. Let's go." / "Alright, that's my first set." / "Let's roll into the next set." / "Second set done. One more set and we're good." / "Feeling the pump, total body, all over my shoulders and my abs right now."
- Put it in between 4:48 and the call to action. In the reference edit it runs 4:37 to 6:20. Cut each set wide / punch-in / wide so it reads as coverage, not one locked shot.
...
- 5:06 to 5:08 shows the app's "Enter Your Email To Download... Get My Download" screen. This is a hard rule: no email-capture form on screen, ever. Cut the app clip before that screen appears. Details in the 4:54 item below.

**AI LABEL POSITION**

- Every AI clip now carries the label at the right size, which is good, but it sits in the upper RIGHT. The rule is upper LEFT. One move, eight clips: 0:10, 0:17, 1:03, 1:13, 1:31, 3:19, 4:18, 4:38.

## TIMESTAMPED REVISIONS

**0:53 - 0:58 - the man in the grey tank top**

- The line is "if you're a ripped monster bodybuilder." The man on screen is an average-build guy walking past treadmills. Replace with a visibly shredded man, white or Asian, 30 to 50, either mid-rollout or standing, neutral light, about 3 seconds. Label \*AI Generated if generated.

**1:07 - 1:13 and 1:28 - 1:31 - the tick marks**

- The ticks are still the bright neon green in a grey rounded square from round 1. Use a tick in the brand olive on the same dark green plate as the text, or drop the icon entirely and use the plain chip style from 0:25.

**1:52 and 4:40 - the empty square**
...
- Right idea, wrong execution. The phone is about a fifth of the frame width sitting in a plain olive field, and 11 of the 15 seconds are a "Generating..." progress bar over the before photo. Nobody will watch a progress bar for 11 seconds.
...
- Mean brightness is now 119 against the reference edit's 131. Closer. One more nudge up on exposure and warmth on the talking-head shots and it matches.

**END CARD 5:16 - 5:19**

- Good. Keep it. Hold it a beat longer, about 4 seconds instead of 3, so the address is readable.
