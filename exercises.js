...
const EXERCISES = [
  ...
  { id: 'bb-back-squat', name: 'Barbell Back Squat', equip: 'gym', cat: 'legs', muscles: 'quads, glutes, core',
    setup: 'Bar on upper traps in a rack, feet shoulder-width, toes slightly out.', execution: 'Brace, sit down until thighs are at least parallel, drive up through mid-foot.', mistake: 'Knees caving on the way up — push them out over the toes.', swap: 'db-goblet-squat', video: 'https://www.youtube.com/watch?v=8PMjqgR8Wa8' },
  { id: 'bb-deadlift', name: 'Barbell Deadlift', equip: 'gym', cat: 'legs', muscles: 'hamstrings, glutes, back',
    setup: 'Bar over mid-foot, hinge to grip just outside the legs, flat back, shoulders over the bar.', execution: 'Push the floor away and stand tall, bar dragging up the legs; hinge it back down the same path.', mistake: 'Rounding the lower back off the floor — take slack out of the bar and brace first.', swap: 'db-rdl', video: 'https://www.youtube.com/watch?v=GxsLrTzyGUU' },
  ...
  { id: 'bb-bench-press', name: 'Barbell Bench Press', equip: 'gym', cat: 'push', muscles: 'chest, triceps, shoulders',
    setup: 'Lie with eyes under the bar, feet planted, slight arch, grip a bit wider than shoulders.', execution: 'Lower the bar to mid-chest with elbows ~45°, press back to lockout over the shoulders.', mistake: 'Bouncing off the chest — touch and press, no rebound.', swap: 'db-bench-press', video: 'https://www.youtube.com/watch?v=HmzhfGUGQRc' },
