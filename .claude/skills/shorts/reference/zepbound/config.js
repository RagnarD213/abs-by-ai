...
module.exports = {
  ...
  // insert coverage, so cutting from FINAL_zepbound.mp4 would make nearly half of every
  ...
  SRC: path.join(PROJ, 'claude edited long form content/02 - My Honest Zepbound Update/CUT_v1_graded_NO-GRAPHICS.mp4'),
  ...
  RAW: '/Volumes/Extreme/abs by ai 8:3 jeff chagrin shoot/main camera/C1513.MP4',
  RAW_WORDS: '/Volumes/Extreme/_edit_work/zepbound/C1513.whisper.json',
