...
// THIS ROLL: Whisper hears the drug name as "zap bound" / "Zetbound" and once as "dirt zap
// bound" ("your Zepbound"). Every instance checked against the delivered 881-cue SRT, which
// reads "Zepbound" in all of them. Captions print what he SAYS - the no-drug-name rule is a
// GRAPHICS rule (titles, eyebrows, chips) and organic Shorts may name it in speech.
const PAIR_FIXES = [[/^zap$/i, /^bound$/i, 'Zepbound'],
  // E: pass a hears "people who are of severe obesity"; the delivered SRT (an independent
  // transcription) reads "who have severe obesity". Only occurrence of "are of" in the batch.
  [/^are$/i, /^of$/i, 'have']];
const WORD_FIXES = [
  [/^Zetbound$/i, 'Zepbound'],
  [/^dirt$/i, 'your'],          // "So dirt zap bound will take about 24 hours" = "So your Zepbound"
  [/^Lily$/, 'Lilly'],
