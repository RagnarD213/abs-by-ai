...
OURS=f"{PROJ}/claude edited long form content/02 - My Honest Zepbound Update/CUT_v1_graded_NO-GRAPHICS.mp4"
...
# ⚠ ZEPBOUND ROLL: NO afftdn, NO GATE. Measured floor-relative-to-voice on the plain right
# channel: 29.1 / 39.4 / 31.1 dB (80-250 / 250-1k / 1-4k) against his AD's 25.7 / 36.1 / 28.8 -
# this roll is ALREADY 3 dB cleaner than the reference in every band. The supplements batch
# needed the cleanup because its floor sat 6-8 dB ABOVE his; here the same gate would only eat
# word tails (validate_chain measured 98.7% word match with it, 100% without) and pump.
BASE=("pan=mono|c0=c1,"
      "highpass=f=75:p=2")                                    # rumble only
def load(f,af,t,d):
