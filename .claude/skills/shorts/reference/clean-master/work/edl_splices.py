...
EDL = json.load(open("/Users/danielrose/Documents/Claude/Projects/Abs By AI/claude edited long form content/03 - The Supplements I Actually Take/edl.json"))
...
print(f"{len(rows)} ranges; total float {tx:.3f}s  frame-quantised {tf:.3f}s  "
      f"(master is 1409.523s)  drift {tf-tx:+.3f}s")
