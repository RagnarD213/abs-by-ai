...
The clean master carries the unrepaired two-mic recording; only FINAL_supplements.mp4 got the
...
BASE = "/Users/danielrose/Documents/Claude/Projects/Abs By AI/claude edited long form content/03 - The Supplements I Actually Take/"
CLEAN, FINAL = BASE+"CUT_v1_graded_NO-GRAPHICS.mp4", BASE+"FINAL_supplements.mp4"
