...
SRC={
 'OUR source (right ch, raw)': (f"{PROJ}/claude edited long form content/03 - The Supplements I Actually Take/CUT_v1_graded_NO-GRAPHICS.mp4",'pan=mono|c0=c1',(200,1400)),
