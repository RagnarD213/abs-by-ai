#!/usr/bin/env python3
"""Deliver the Ad 4 vertical (full length + the <=0:59) beside Muhammad's V4 HD under the editor-deliveries convention
...
HIS_SRC = 'ref/ad4_v4_hd.mp4'
FILES = [  # (work file, delivered name, his mix for the verbatim gate)
    ('ad4_vertical_9x16.mp4',         f"{T} | claude | 9x16 | ad 4.mp4",      'his_mix.wav'),
    ('cut/ad4_vertical_9x16_59s.mp4', f"{T} | claude | 9x16 59s | ad 4.mp4",  'cut/his_mix.wav'),
]
def md5(p):
    h = hashlib.md5()
    with open(p, 'rb') as f:
...
his = os.path.join(DEST, f"{T} | muhammad | 16x9 | ad 4.mp4")
if not os.path.exists(his): shutil.copyfile(HIS_SRC, his); print('filed his V4 HD as', os.path.basename(his))
...
for f in ['beats.py', 'g5.py', 'g8.py', 'render8.py', 'zassets4.py', 'zmatch4.py', 'zmatch4b.py', 'zmatch4c.py', 'captions.py', 'align_ctc.py', 'caption_sync_check.py', 'zmux.py', 'zalign.py', 'zprofile2.py',
          'zfit.py', 'zfit_right.py', 'zpic2.py', 'zedl.py', 'zedl3.py', 'zlut.py', 'zvig.py', 'zbase.py', 'zmeasure.py', 'zhair.py', 'zcrop.py',
          'zhairgate2.py', 'zcutdown.py', 'zcut_build.py', 'watch.py', 'landing_check.py', 'centering.py',
          'deliver4.py', 'hdcheck2/hd_vs_draft.json', 'edl_picture.json', 'crop.json', 'fit.json', 'offset_profile.json', 'vignette.json', 'his.cube', 'cut_plan.json',
