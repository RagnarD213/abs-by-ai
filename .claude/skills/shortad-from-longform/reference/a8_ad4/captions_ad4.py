...
# Whisper's readings of Muhammad's Ad 5 V3 mix (2026-09-10) checked against the script: two spellings normalised. They are HIS words on screen, so a
# mis-transcription burned into the captions is a spelling mistake in the ad.
# Ad 4 (Muhammad V4 HD, 2026-09-11): Whisper small's readings settled ACOUSTICALLY (CTC NLL of each full phrase under the
# aligner's own wav2vec2, skill A6.23) and against Whisper medium: "name it" 155.8 vs "made it" 160.8 (medium agrees);
# "can't" 64.9 vs "can" 66.6 (and the sentence needs it: "...and you can't. ... Nobody can."); "abs", not "ads" (d/b is
# below what CTC separates in this mix -- 29.4 vs 32.1 -- and the ad is about abs); "tub" -- the greedy CTC decode reads
# "TOP" (short vowel + plosive), which is "tub", not Whisper's "tone"/"tongue". "my supplements that workouts" stays: CTC
# scores it 23.0 against 54-57 for every cleaner reading -- it is what he says.
FIX = {('You', 'made', 'it,'): ('You', 'name', 'it,'), ('and', 'you', 'can.'): ('and', 'you', "can't."),
       ('with', 'ads,'): ('with', 'abs,'), ('the', 'tone.'): ('the', 'tub.'),
       ('science', '-based'): ('science-based', '')}     # Whisper splits the hyphen: 'science -based' was burned with a space (audit 1)
