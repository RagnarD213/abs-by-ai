#!/usr/bin/env python3
"""Deliver the Ad 3 vertical (full length + the <=0:59) beside Muhammad's ad 3 folder under the editor-deliveries convention
...
DEST = "/Users/danielrose/Documents/Claude/Projects/Abs By AI/Muhammad Ad Videos/stop paying human trainers - ad 3"
T = "stop paying human trainers"
HIS_SRC = 'ref/ad3_v6hd.mp4'
FILES = [  # (work file, delivered name, his mix for the verbatim gate)
    ('ad3_vertical_9x16.mp4',         f"{T} | claude | 9x16 | ad 3.mp4",      'his_mix.wav'),
    ('cut/ad3_vertical_9x16_59s.mp4', f"{T} | claude | 9x16 59s | ad 3.mp4",  'cut/his_mix.wav'),
]
def md5(p):
    h = hashlib.md5()
    with open(p, 'rb') as f:
...
if '--master-only' in sys.argv: FILES = FILES[:1]   # cutdown held: its -0.90 dBTP AAC overshoot waits on Dan (2026-09-14)
# Muhammad's own HD export, filed beside ours under the convention (the /editor-deliveries rule)
# NOT filed: his v6 HD is not the approved round-5 draft (2:14.1-2:23.1 lost four lines of the "Because even though I was
# a personal trainer..." bullet -- hdcheck/w4_hd_vs_draft.png). Dan asks him to re-export; /editor-deliveries files the fixed one.
...
for f in ['beats.py', 'g5.py', 'g3.py', 'render3.py', 'zmatch3.py', 'zov3.py', 'lift3.py', 'zcutdown3.py', 'prep.sh', 'captions.py', 'align_ctc.py', 'caption_sync_check.py', 'zmux.py', 'zalign.py', 'zprofile2.py',
          'zfit.py', 'zfit_right.py', 'zpic2.py', 'zedl.py', 'zedl3.py', 'zlut.py', 'zvig.py', 'zbase.py', 'zmeasure.py', 'zhair.py', 'zcrop.py',
          'zhairgate2.py', 'zcut_build.py', 'watch.py', 'landing_check.py', 'centering.py',
          'deliver3.py', 'zgrade2.py', 'zgrade3.py', 'zgrade4.py', 'zlabelplace.py', 'grade_post.json', 'grade_seg.json', 'grade_final.json', 'label_place.json', 'master15.sh', 'gates12.sh', 'cut6.sh', 'finish12.sh', 'hdcheck/hd_vs_draft.json', 'hdcheck/w4_hd_vs_draft.png', 'edl_picture.json', 'crop.json', 'fit.json', 'offset_profile.json', 'vignette.json', 'his.cube', 'cut_plan.json',
