"""Moved to .claude/skills/_shared/sfxlib.py (2026-08-24).

/longform-edit needs the same transition-SFX pack /ad-edit has been using since
...
from sfxlib import *          # noqa: F401,F403
