...
For website videos: `softblue.lower_third` replaces `lower_third_bar(bottom=1000)` in Step 3; fact cards, the three-portrait screen and the CTA come from `softblue` scenes. WV-01's own crops, colour C and audio B stay scoped to WV-01.
