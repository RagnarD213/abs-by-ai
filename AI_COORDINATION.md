...
**DS-18 picture sync - READY 2026-09-25, Codex.** Dan requested four correct-form/mistake pairs reordered to match speech. New task: `Handoffs/handoff-20260925-ds18-sync-demonstrations.md`. Current R6 remains delivered but superseded for review. No upload or publishing. Work: `/Volumes/Extreme/_edit_work/ds18-kettlebell-deadlift/`.
