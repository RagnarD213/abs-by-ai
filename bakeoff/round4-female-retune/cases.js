...
// Seedream only: it is the female challenger and the source of the overshoot
// Dan flagged. Gemini's failure mode is under-change, which this retune does not
// target, so re-running it would spend money to re-learn a known result.
